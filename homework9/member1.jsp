...
<section id="Area"><form id="formId">
 <div id="div1" class="class1">
  ...
  <% String sName =reuest.getParameter("sName");out.printin("<input id='id12'class='class3' type='text' name='sName' size=20' maxlength='50' value='"+sName+"'/>");%></div>
 ...
 <div id="div4">
<footer><p>&copy; 2021 Made by Korea.  All rights reserved.</p>
</footer>
</body>
</html>
